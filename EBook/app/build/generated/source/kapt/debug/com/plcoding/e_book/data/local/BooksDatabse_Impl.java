  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `Result` (`authors` TEXT NOT NULL, `available` INTEGER NOT NULL, `bookQuantity` INTEGER NOT NULL, `createAt` TEXT NOT NULL, `createBy` TEXT NOT NULL, `description` TEXT NOT NULL, `discount` INTEGER NOT NULL, `galleryManage` TEXT NOT NULL, `hot` INTEGER NOT NULL, `id` INTEGER, `language` TEXT, `num_pages` INTEGER NOT NULL, `price` INTEGER NOT NULL, `provider` TEXT, `publication_date` TEXT NOT NULL, `publisher` TEXT, `title` TEXT NOT NULL, `total_pay` INTEGER NOT NULL, `updateAt` TEXT NOT NULL, `updateBy` TEXT NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'd81f409d47e41386a59cb2ff6d7ace7c')");
      }
    ...
    }, "d81f409d47e41386a59cb2ff6d7ace7c", "9719742c15de1862392da29c0b7e5891");
