  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `Result` (`authors` TEXT NOT NULL, `available` INTEGER NOT NULL, `bookQuantity` REAL NOT NULL, `categoryId` INTEGER NOT NULL, `createAt` TEXT NOT NULL, `createBy` TEXT NOT NULL, `description` TEXT NOT NULL, `discount` INTEGER NOT NULL, `feedback` TEXT NOT NULL, `galleryManage` TEXT NOT NULL, `hot` INTEGER NOT NULL, `id` INTEGER NOT NULL, `isebook` INTEGER NOT NULL, `isvip` INTEGER NOT NULL, `language` TEXT NOT NULL, `num_pages` INTEGER NOT NULL, `price` INTEGER NOT NULL, `provider` TEXT NOT NULL, `publication_date` TEXT NOT NULL, `publisher` TEXT NOT NULL, `readingsession` INTEGER NOT NULL, `title` TEXT NOT NULL, `total_pay` INTEGER NOT NULL, `updateAt` TEXT NOT NULL, `updateBy` TEXT NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '6d9f861b00968b6dd0df8725b70a7eab')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsResult.put("bookQuantity", new TableInfo.Column("bookQuantity", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsResult.put("categoryId", new TableInfo.Column("categoryId", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsResult.put("language", new TableInfo.Column("language", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsResult.put("provider", new TableInfo.Column("provider", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsResult.put("publication_date", new TableInfo.Column("publication_date", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsResult.put("publisher", new TableInfo.Column("publisher", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "6d9f861b00968b6dd0df8725b70a7eab", "678fb50127bba38d7ed3ad6e87001ba5");
