  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `Result` (`authors` TEXT NOT NULL, `available` INTEGER NOT NULL, `bookQuantity` REAL NOT NULL, `category` TEXT, `createAt` TEXT NOT NULL, `createBy` TEXT NOT NULL, `description` TEXT NOT NULL, `discount` INTEGER NOT NULL, `feedback` TEXT, `galleryManage` TEXT NOT NULL, `hot` INTEGER NOT NULL, `id` INTEGER NOT NULL, `isebook` INTEGER NOT NULL, `isvip` INTEGER NOT NULL, `language` TEXT NOT NULL, `num_pages` INTEGER NOT NULL, `price` INTEGER NOT NULL, `provider` TEXT NOT NULL, `publication_date` TEXT NOT NULL, `publisher` TEXT NOT NULL, `readingsession` INTEGER NOT NULL, `title` TEXT NOT NULL, `total_pay` INTEGER NOT NULL, `updateAt` TEXT NOT NULL, `updateBy` TEXT NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '403e46277fb0067f6aa4d8866b053019')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsResult.put("feedback", new TableInfo.Column("feedback", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "403e46277fb0067f6aa4d8866b053019", "bc8b5e08f9d92592f46824d7b489b905");
