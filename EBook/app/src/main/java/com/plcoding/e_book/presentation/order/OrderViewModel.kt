...
class OrderViewModel : ViewModel(){
    ...
    init {
        val token = "bearier eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJjb20uYXV0aGVudGljYXRpb24iLCJzdWIiOiJiZWhlbzEyIiwiZXhwIjoxNzE2MzU3OTMxLCJpYXQiOjE3MTYzNTQzMzEsInNjb3BlIjoiQ1VTVE9NRVIgR0VUX01ZX0JPT0tTIENSRUFURV9PUkRFUiBDQU5DTEVfT1JERVIgR0VUX01ZX1BBWU1FTlRTIn0.vBVy4cEvMdY3AR5tQPkfwuGSzyatgnyxxjP9PyUadBY"
    ...
    viewModelScope.launch {
        try {
            ...
            if (response.isSuccessful) {
                if (responseAPI != null) {
                    Log.d("OrderViewModel", "Order created successfully, Order ID: ${responseAPI.result.id}")
                }
            } else {
